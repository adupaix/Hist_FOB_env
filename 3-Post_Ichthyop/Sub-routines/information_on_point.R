...
fnames <- list.files(file.path(sim_output_path, point$id), pattern = "rds")

# read rds file
data <- readRDS(file.path(sim_output_path, point$id, fnames[1]))
...
# get forest surface (release_date, point_coords, point_associated_rivers)
