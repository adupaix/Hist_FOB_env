...
#'@email : 
#'#*******************************************************************************************************************
#'@description :  Config file to generate input points for Ichthyop simulations
#'
#'The main script is organized in 2 sub-routines
#'       1. Generate the list of points from which particles are to be released in Ichthyop
#'          Save them into several formats (.shp, and .txt)
#'       2. From the list of points and the release dates, generate .xml cfg files that will be used in Ichthyop
#'          Also generate .pbs jobs, to run the Ichthyop simulation on a cluster
#'#*******************************************************************************************************************
#'@revisions
#'
#'#*******************************************************************************************************************
...
#'## sim_input/output_path/path_where_the_forcing_product_is_stored (chr): paths to be saved in the cfg files
#'
...
#'                        Now the first job (sim_ichthyop_year-0.pbs) will copy the forcing products to the sim_input_path
#'                        @but the config files need to be stored in "path_where_the_forcing_product_is_stored/[curr_prod]/"
...
sim_output_path <- "/home/datawork-marbec-pmod/outputs/ICHTHYOP/adupaix/2000"
