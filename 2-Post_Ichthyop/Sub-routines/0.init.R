...
mapName <- file.path(NEW_OUTPUT_PATH, paste0("Per_",agg.time_scale,"_2.mean_maps.png"))
...
if (any(RESET) & any(filesExist)){
  ...
  # if RESET[1] = T, delete the files generated by the first sub_routine which exist
  if(RESET[1]){
    invisible(file.remove(c(globalName, meanAggName, aggregateName)[filesExist[2:4]] ))
  }
